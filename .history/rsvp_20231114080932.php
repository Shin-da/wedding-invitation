          ...
          <div class="modal-content">
            ...
            <form class='form' action='check_response.php' method='POST'>
              ...
              <div class='d-flex justify-content-center flex-row'>
                <div>
                  <div class="d-flex flex-column" style="margin:-12%;">
                    <h3>Are you</h3>
                    <div>
                      <h3><label for="comingRadio">Coming</label>
                      ...
                      <h3 style="margin-bottom: 12%;"> <label for="notComingRadio">Not Coming</label>
                        <input type='radio' id="notComingRadio" name='action' width="20px" height="20px" style="font-family: 'Goladon', sans-serif;" value='Not Coming'>
                      </h3>
                    </div>
                  </div>
                </div>
              ...
              <div>
                <input style="font-family: 'Goladon', sans-serif; background-color:#152630;color:#c19c60;" width="20px" height="20px"class='btn btn-primary' type='submit' value='Submit'>
