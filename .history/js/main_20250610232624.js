...
const weddingDate = new Date('2023-12-08T14:00:00').getTime();
...
function updateCountdown() {
    ...
    const seconds = Math.floor((distance % (1000 * 60)) / 1000);    if (distance < 0) {
        // If the wedding date has passed
        countdownElement.innerHTML = `
            <div class="countdown-complete">
                <h3>The wedding has already taken place!</h3>
