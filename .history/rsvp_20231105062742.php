...
<body class="fadeOut">
  ...
  // Close the confirmation modal when the "Close" button or close icon is clicked
  ...
  $('#editButton').click(function() {
    ...
    // Optionally, you can perform additional actions for the "Edit" button.
  });
  ...
  $('#okayButton').click(function() {
    ...
    // Optionally, you can perform additional actions for the "Okay" button.
  });
});
