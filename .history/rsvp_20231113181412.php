...
<body class="fadeOut">
  ...
  <nav class="navbar navbar-expand-lg navbar fixed-top" id="mainNav"   box-shadow: 0px 3px 15px rgba(0,0,0,0.2);">
  ...
  <div class="container-fluid story" id="details">
    <div class="container content " style=" width:100vw; 
      ...
      <div class="container-fluid content"  data-aos="fade-up" style="background-color:#d2b48c; height:40vh; width:60vw; padding:4vw; ">
          ...
          <div class="modal-content">
            ...
            <form class='form' action='check_response.php' method='POST'>
              ...
              <table id='myTable' class='table table-bordered'>
                ...
                </div>  <tbody id="modalContent"></tbody>
        ...
        <div class="modal" id="alreadySubmittedModal" style="display: none;">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary" type="button"  id="closeModal" aria-label="Close">Okay</button>
            </div>
          </div>
        </div>
      </div>
