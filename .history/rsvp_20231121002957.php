...
<body class="fadeOut">
  ...
  <div class="container-fluid story" id="rsvp">
    <div class="container content " height="200vh">
      ...
      <div class="container-fluid " data-aos="fade-up" style="background-color:#263a45; margin-top:3%; width:60vw; padding:7vw; border-radius: 1pc;">
      ...
      font-family: 'Dancing Script'; color:#c19c60;">
          ...
          <h6 class="h6 text-center" style="font-family: 'Goladon', sans-serif; color:#f9f9f9;">
            Please type in y ent name. For those who have title, include it in the first name.
          </h6>
          <br>
      ...
      <div class="container-fluid">
            ...
            <form class='form' action='check_response.php' method='POST'>
              ...
              <div class='d-flex justify-content-center flex-row'>
                <div class="d-flex flex-column align-items-center form">
                  <h3 style="font-size: 40px;">Are you</h3>

                  <div class="d-flex flex-column" style="font-family: 'Goladon', sans-serif;font-size:33px;color:#c19c60;">
                    ...
                    <div style="font-family: 'Goladon', sans-serif; color:#4a0a0a;">
                      <label for="notComingRadio">
                        <input class="inputR" type='radio' id="notComingRadio" name='action' value='Not Coming'>
                        Not Coming
                      </label>
                    </div>
        ...
        <div class="modal" id="alreadySubmittedModal" style="display: none; ">
          <div class="modal-content container" style="background-color:#263a45;font-family: 'love rose', sans-serif;">
