        ...
        <div class="container">
          ...
          <form id="getUserForm" action="process.php" method="POST">
            <span style="font-family: 'Dancing Script';">
              ...
              <button type="button" class="submit " style="background-color: #c19c60; color:#fff3e7;" id="submit"> Submit</button><button type="submit" class="btn mx-auto" style="background-color: #c19c60; color:#fff3e7; 
      font-family: 'Goladon', sans-serif;" fdprocessedid="l8eyhd">Submit</button>
              </div>
