...
<body class="fadeOut">
  ...
  <div class="modal" id="endmessage" style="display: none; ">
      <div class="modal-content container" style="background-color:#263a45;">
        <div class="modal-body lbl-inp text-center" style="color">
          <h3>
        ...
        <div class="modal-footer">
          <button type="button" class="btn " type="button" style="background-color: #c19c60; color:#fff3e7;"
            id="closeEndMessage" aria-label="Close">Okay</button>
        </div>
      </div>
    </div>
