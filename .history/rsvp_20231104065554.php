...
<body class="fadeOut">
  ...
  <div class="container-fluid welcome" id="entourage">
    <div class="container" style="background-color:#af8d6b; margin-top:1vh;">
        ...
        <tbody>
          ...
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
              echo "<tr>
                    <td>" . $row["name"] . "<td><input type="radio" name="choice1" value="option1"></td>
                    <td><input type="radio" name="choice1" value="option2"></td>
      ...
      <input class="btn btn-primary" type="submit" value="Submit" onclick="location.href='index.php?id=<?php echo $id; ?>'">
    </div>
  </div>
