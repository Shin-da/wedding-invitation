 ...
 if ($stmt) {
    ...
    $userData = "
        <div class='mb-3'>
            ...
            <input type='text' id='firstName' class='form-control' value='$firstName' disabled><!-- User's First Name -->
        </div>
        <div class='mb-3'>
            <label for='lastName'>Last Name:</label>
            <input type='text' id='lastName' class='form-control' value='$lastName' disabled><!-- User's Last Name -->
        </div>
    ";
