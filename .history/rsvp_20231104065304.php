...
<body class="fadeOut">
  ...
  <div class="container-fluid welcome" id="entourage">
    <div class="container" style="background-color:#af8d6b; margin-top:1vh;">
            ...
            while ($row = $result->fetch_assoc()) {
              echo "<tr>
                    ...
                    <th>""Option 1"</th>
                        <th>Option 2</th>
                    <td class='action'>
                    <td><input type="radio" name="choice2" value="option1"></td>
                    <td><input type="radio" name="choice2" value="option2"></td>
                    </td>
                  </tr>";
            }
          } else {
      ...
      <input class="btn btn-primary" type="submit" value="Update" onclick="location.href='index.php?id=<?php echo $id; ?>'">
    </div>
  </div>
