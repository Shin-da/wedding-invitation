...
<head>
  ...
  <script>
    $(document).ready(function() {
      ...
      // Close the "You have already submitted a response" modal when the "Okay" button is clicked
      $('#endmessage').on('click', '#closeAlreadySubmittedModal', function() {
...
<body class="fadeOut">
  ...
  <div class="modal" id="endmessage" style="display: none; ">
    <div class="modal-content container" style="background-color:#263a45;">
      ...
      <div class="modal-footer">
        <button type="button" class="btn " type="button" style="background-color: #c19c60; color:#fff3e7;" id="closeEndSubmittedModal" aria-label="Close">Okay</button>
      </div>
    </div>
