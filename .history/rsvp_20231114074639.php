      ...
      <div class="container-fluid " data-aos="fade-up" style="background-color:#263a45; margin-top:3%; height:70vh; width:80vw; padding:4vw; border-radius: 1pc;">
        ...
        <div class="container">
          ...
          <form id="getUserForm" action="process.php" method="POST">
            ...
            <button type="submit" class="btn mx-auto" style="background-color: #c19c60; color:#fff3e7; ">Submit</button>
      ...
      <div class="container-fluid">
        ...
        <div class="modal container " id="userModal" style="display: none; ">
          <div class="modal-content">
            <span class="close" id="closeModal" width="50px ">&times;</span>
            ...
            <form class='form' action='check_response.php' method='POST'>
              ...
              <div class='d-flex justify-content-center flex-row'>
                <div class="d-flex flex-coolumn">
                  <div>
                    <h2><label for="comingRadio">Coming</label>
                    <input type='radio' id="comingRadio" name='action' width="40px"height="40px" color="#c19c60"  value='Coming'></h2>
                  </div>

                  <div>
                    <h2> <label for="notComingRadio">Not Coming</label>
                    <input type='radio' id="notComingRadio" name='action' width="40px" height="40px" color="#c19c60" value='Not Coming'></h2>
                  </div>
                </div>

                <br>
                <div>
                  <input class='btn btn-primary' color="#c19c60" type='submit' value='Submit'>
