...
<body class="fadeOut">
  ...
  <div class="container-fluid welcome">
    <div class="container-fluid " data-aos="zoom-in" style="background-color:#af8d6b; height:30vh; width:60vw; padding:4vw;">
      <div class="container">
        <form id="getUserForm" style="gap:4vw;" action="process.php" method="POST">
          <div>
