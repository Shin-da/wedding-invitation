    ...
    $.ajax({
      ...
      success: function(response) {
        if (response === 'not_submitted') {
          ...
          $.ajax({
            type: 'POST',
            url: 'add.php', // Add the URL for add.php here
            data: {
              id: userId,
              action: selectedAction,
            },
            success: function(addResponse) {
              // Handle the response from add.php here
              alert(addResponse); // For testing purposes
            },
          });
        } else {
          // Handle the case where the user has already submitted a response
