  ...
  <div class="container-fluid story" id="rsvp ">
    <div class="container content " height="200vh">
      ...
      <div class="container-fluid">
          ...
          <div class="modal-content">
            ...
            <form class='form' action='check_response.php' method='POST'>
              ...
              <div class='d-flex justify-content-center flex-row'>
                <div>
                  <div class="d-flex flex-column form" style="margin:-12%;">
                    <h3>Are you</h3>
                    <div class="lbl-inp">
        ...
        <div class="modal" id="alreadySubmittedModal" style="display: none; background-color:#263a45;">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary" type="button" style="background-color: #c19c60; color:#fff3e7;"  id="closeModal" aria-label="Close">Okay</button>
            </div>
          </div>
        </div>
      </div>
