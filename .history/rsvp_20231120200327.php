...
<body class="fadeOut">
  ...
  <div class="container-fluid story" id="rsvp">
    <div class="container content " height="200vh">
      ...
      <div class="container-fluid " data-aos="fade-up" style="background-color:#263a45; margin-top:3%; height:70vh; width:60vw; padding:7vw; border-radius: 1pc;">
  ...
  <div class="modal" id="endmessage" style="display: none; ">
    <div class="modal-content container" style="background-color:#263a45;font-family: 'Spaceroom', sans-serif;
                                                ">
