                ...
                <div class="d-flex flex-column">
                  <div>
                    <h2><label for="comingRadio">Coming</label>
                      <input type='radio' id="comingRadio" name='action' width="40px" height="40px" accent-color="#c19c60"   value='Coming'>
                    </h2>
                  </div>

                  <div>
                    <h2> <label for="notComingRadio">Not Coming</label>
                      <input type='radio' id="notComingRadio" name='action' width="40px" height="40px" accent-color="#c19c60" value='Not Coming'>
                    </h2>
                  </div>
                </div>
