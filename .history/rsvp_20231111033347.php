...
<head>
  ...
  <script>
    $(document).ready(function() {
      // Show the form when the RSVP button is clicked
...
<body class="fadeOut">
  ...
  <div class="container-fluid story" id="details">
    <div class="container content " style=" width:100vw; 
      ...
      <button id="showRSVPForm">RSVP</button>

      <div class="container-fluid content" id="rsvpFormContainer" data-aos="fade-up" style="background-color:#d2b48c; height:40vh; width:60vw; padding:4vw; display: none;">
        <div class="container">
