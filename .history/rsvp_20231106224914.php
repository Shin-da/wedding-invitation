        ...
        $.ajax({
            ...
            success: function(response) {
                if (response === 'not_submitted') {
                    // The user has not submitted a response
                    // Proceed to save the response in the database (add.php)
                    $.ajax({
                        type: 'POST',
                        url: 'add.php',
                        data: {
                        ...
                        success: function(addResponse) {
                            // Handle the response from add.php
                ...
                } else (response === 'already_submitted'); {
