    ...
    if (selectedAction) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                } else if (response === 'not_submitted') {
                    // Handle the case where the user is allowed to submit a response
                    // You can proceed to save the response in the database
                    // Add your code here to save the response
                    // For testing purposes, you can show an alert like this:
  ...
  <div class="container" style="background-color:#af8d6b; margin-top:1vh;">
    ...
    <table id='myTable' class='table table-bordered'>
        ...
        <tbody id="modalContent">
            <!-- User data will be populated here --><label for="comingRadio">Coming</label>
