        ...
        <div class="container">
          ...
          <form id="getUserForm" action="process.php" method="POST">
            ...
            <div class="mb-3 d-flex flex-row">
              <label for="first_name" class="form-label" style="color: #fff3e7; font-size:2em; width:40%;">First Name:</label>
            ...
            <form class='form' action='check_response.php' method='POST'>
              ...
              <div class='d-flex justify-content-center flex-row'>
                <div class="d-flex flex-coolumn">
                  <div>
                    <h2><label for="comingRadio">Coming</label></h2>
                    <input type='radio' id="comingRadio" name='action' value='Coming'>
                  </div>

                  <div>
                    <h2> <label for="notComingRadio">Not Coming</label></h2>
