...
<body class="fadeOut">
    ...
    <div class="container px-4 px-lg-5">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item"><a class="nav-link " href=".php"> RSVP</a></li>
        </ul>
      </div>
  ...
  <div class="container-fluid story" id="details">
    <div class="container content ">
      ...
      <div class="container-fluid content" data-aos="fade-up" style="background-color:#263a45; height:80vh; width:60vw; padding:4vw; ">
