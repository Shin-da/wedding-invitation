...
<body class="fadeOut">
  ...
  <div class="container-fluid story" id="rsvp">
    <div class="container content ">
      ...
      <div class="container-fluid content" data-aos="fade-up" style="background-color:#263a45; margin-top:3%; height:80vh; width:60vw; padding:4vw; ">
        ...
        <div class="container">
          ...
          <form id="getUserForm" action="process.php" method="POST">
            ...
            <button type="submit" class="btn mx-auto" style="background-color: #c19c60; ">Submit</button>
          </form>
        </div>
      </div>
