    ...
    <div class="modal" id="userModal">
      <div class="modal-content">
        ...
        <form class='form' action='add.php' method='POST'>
          ...
          <input class='btn btn-primary' type='' value='Submit'>
        </form>
      </div>
    </div>
  </div>
      ...
      <script>
// Inside your rsvp.php's JavaScript code
$.ajax({
  type: 'POST',
  ...
  success: function (userData) {
    ...
    modalContent.append(
      "<tr>" +
      "<td>" + userDataObj.first_name + "</td>" +
      "<td>" + userDataObj.last_name + "</td>" +
      "<td>" +
      "<input type='radio' name='action[" + userId + "]' value='Coming'> Coming " +
      "<input type='radio' name='action[" + userId + "]' value='Not Coming'> Not Coming " +
      "</td>" +
      "</tr>"
    );
