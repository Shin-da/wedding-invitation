...
element.style {
    ...
    @media (max-width:500px) {
      .firstform {
       padding: 19vw;background-color: #4a0a0a;
       position: absolute;
      }
      .story{
        padding: 0;
...
<body class="fadeOut">
  ...
  <div class="container-fluid story" id="rsvp">
    <div class="container content " height="200vh">
      ...
      <div class="container-fluid firstform" data-aos="fade-up" style="background-color:#263a45; margin-top:3%; width:60vw; padding:7vw; border-radius: 1pc;">
