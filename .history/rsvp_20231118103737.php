...
<head>
  ...
  <script>
    $(document).ready(function() {
      ...
      document.getElementById('closeAlreadySubmittedModal').addEventListener('click', function() {
...
<body class="fadeOut">
          ...
          <div class="modal-content container  aos-init aos-animate" data-aos="fade-down">
            ...
            <form class='form' action='check_response.php' method='POST'>
              ...
              <div class="container text-end">
                <input style="font-family: 'Goladon', sans-serif; background-color:#152630;color:#c19c60;" class='btn btn-primary' type='submit' value='Submit' id="action">
  ...
  <div class="modal" id="endmessage" style="display: none; ">
    <div class="modal-content container" style="background-color:#263a45;">
      <div class="modal-body lbl-inp">
        <h3>
          Thank you for confirming your attendance! We're so excited to celebrate our wedding with you. Please don't forget to bring any ID and follow the dress code. See you there!</p>
        </h3>
      </div>
      <div class="modal-footer">
