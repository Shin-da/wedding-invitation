  ...
  <div class="container-fluid">
    <div class="modal" id="successModal" style="display: none; ">
      <div class="modal-content container" style="background-color:#263a45;">
        ...
        <div class="modal-body lbl-inp">
              <h3>Thank you for confirming your attendance! We're so excited to celebrate our wedding with you. Please don't forget to bring any ID and follow the dress code. See you there!</p>
        </div>
      </div>
    </div>
  </div>
