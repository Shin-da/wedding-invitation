          ...
          <div class="modal-content">
            ...
            <form class='form' action='check_response.php' method='POST'>
              ...
              <div class='d-flex justify-content-center flex-row'>
                <div class="d-flex flex-column" style="margin-top: ;">
                  <div>
                  ...
                  <div>
                    <h2> <label for="notComingRadio">Not Coming</label>
                      <input type='radio' id="notComingRadio" name='action' width="20px" height="20px" 
                      style="font-family: 'Goladon', sans-serif;" value='Not Coming'>
                    </h2>
                  </div>
                </div>
