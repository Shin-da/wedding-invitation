...
<body class="fadeOut">
  ...
  style="background-color:#fff3e7;  box-shadow: 0px 3px 15px rgba(0,0,0,0.2);">
  ...
  <div class="container-fluid story" id="details">
    ...
    <div class="container-fluid " data-aos="fade-up"  style="background-color:#d2b48c; height:40vh; width:60vw; padding:4vw; ">
      <div class="container">
