        ...
        <div class="modal" id="alreadySubmittedModal" style="display: none; ">
          <div class="modal-content" style="background-color:#263a45;">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary" type="button" style="background-color: #c19c60; color:#fff3e7;"  id="closeAlreadySubmittedModal" aria-label="Close">Okay</button>
            </div>
          </div>
        </div>
      </div>
