  ...
  <div class="container-fluid welcome">
    <div class="container" style="background-color:#af8d6b; margin-top:1vh;">
      ...
      <input type='hidden' name='id[]' value='" . $row["id"] . "'>
          ...
          <tbody>
            ...
            if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        <td>" . $row["name"] . "</td>
                        <td><input type='radio' name='action[" . $row["id"] . "]' value='Coming'></td>
                        <td><input type='radio' name='action[" . $row["id"] . "]' value='Not Coming'></td>
                    </tr>";
              }
            } else {
              echo "0 results";
        ...
        <input class='btn btn-primary' type='submit' value='Updaz'>
      </form>
