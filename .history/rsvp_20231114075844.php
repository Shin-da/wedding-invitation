                ...
                <div class="d-flex flex-column">
                  ...
                  <div>
                    <h2> <label for="notComingRadio">Not Coming</label>
                      <input type='radio' id="notComingRadio" name='action' width="20px" height="20px" style="
      font-family: 'Goladon', sans-serif;" value='Not Coming'>
                    </h2>
                  </div>
                </div>
              ...
              <div>
                <input style="font-family: 'Goladon', sans-serif; background-color:#152630;"   class='btn btn-primary' color="#c19c60" type='submit' value='Submit'>
