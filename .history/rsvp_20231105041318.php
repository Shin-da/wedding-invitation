  ...
  <div class="container-fluid welcome">
    <div class="container" style="background-color:#af8d6b; margin-top:1vh;">
      ...
      <form id="getUserForm" action="process.php" method="POST">
        ...
        <input type="text" id="firstame" name="firstName" required>
        ...
        $('#getUserForm').submit(function (event) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    // Assuming that the response contains the user data in a suitable format
                    var userData = JSON.parse(response);

                    // Populate the modal with user data
                    $('#userModal tbody').html(userData);
