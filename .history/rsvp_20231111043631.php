...
<link rel="stylesheet" href="style.css">
  ...
  var selectedAction; // Variable to store the selected action
  ...
  function displayUserData(userData) {
    ...
    if ("firstName" in userDataObj && "lastName" in userDataObj) {
      // Populate the First Name and Last Name fields in the form
      $('#firstName').val(userDataObj.firstName);
      $('#lastName').val(userDataObj.lastName);
    }
  ...
  <div class="container-fluid story" id="details">
    <div class="container content " style=" width:100vw; 
      ...
      <div class="container-fluid content" id="rsvpFormContainer" data-aos="fade-up" style="background-color:#d2b48c; height:40vh; width:60vw; padding:4vw; display: none; position: relative;">
        <button type="button" class="btn-close" aria-label="Close" id="closeRSVPForm" ></button>
        <div class="container">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title">RSVP Form</h5>
      ...
      <div class="modal-body">
        <form class="form" action="check_response.php" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" id="firstName" class="form-control" disabled><!-- User's First Name -->
          </div>
          <div class="mb-3">
            <label for="lastName">Last Name:</label>
            <input type="text" id="lastName" class="form-control" disabled><!-- User's Last Name -->
          </div>

          <div class="mb-3">
            <label>Action:</label>
            <div class="form-check">
              <input type="radio" id="comingRadio" name="action" value="Coming" class="form-check-input">
              <label for="comingRadio" class="form-check-label">Coming</label>
            </div>
            <div class="form-check">
              <input type="radio" id="notComingRadio" name="action" value="Not Coming" class="form-check-input">
              <label for="notComingRadio" class="form-check-label">Not Coming</label>
            </div>
          </div>
